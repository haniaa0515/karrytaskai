      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Intelligent Productivity, <br className="hidden sm:block" />Personalized Experience
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with advanced AI technology to understand your habits, automate workflows, and boost productivity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="KarryTask learns from your productivity patterns, priorities, and time habits to build a personalized system."
            index={0}
          />
          <FeatureCard
            ...
            description="Communicate with Mr. Karry using natural voice commands or text chat for seamless task management."
            index={1}
          />
          <FeatureCard
            ...
            description="Automatically schedule tasks and meetings based on your availability, priorities, and productivity patterns."
            index={2}
          />
          <FeatureCard
            ...
            description="Send emails on your behalf using your connected Gmail account with AI-powered content generation."
            index={3}
          />
          <FeatureCard
            ...
            description="Connect with Gmail, Slack, Notion, Calendar, and other tools to spawn AI agents in each platform."
            index={4}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M3 3v18h18"></path><path d="M18.7 8.7l-5 5L9.5 9.5l-5 5"></path><circle cx="18" cy="6" r="3"></circle></svg>}
            title="Analytics & Insights"
            description="Track productivity metrics, identify procrastination patterns, and get insights to optimize your workflow."
            index={5}
          />
        </div>
      </div>
