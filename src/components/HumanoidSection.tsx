...
const HumanoidSection = () => {
  ...
  return <div ref={sectionRef} className="relative" style={{
    height: '300vh'
      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="ai-productivity">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            ...
            <h2 className="section-title text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-1 md:mb-2">Why KarryTask AI?</h2>
          </div>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            opacity: isFirstCardVisible ? 0.9 : 0
              ...
              <div className="absolute inset-0 z-0 bg-gradient-to-br from-gray-900 via-blue-950 to-black border border-gray-700/50" style={{
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-blue-500/80 backdrop-blur-sm text-white shadow-lg">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4 drop-shadow-lg">
                    We're giving AI the ability to understand your productivity patterns
                  </h3>
                </div>
              </div>
            </div>
            ...
            pointerEvents: isSecondCardVisible ? 'auto' : 'none'
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4 drop-shadow-lg">
                    We're bringing intelligent automation to your digital workspace
                  </h3>
                </div>
              </div>
            </div>
            ...
            pointerEvents: isThirdCardVisible ? 'auto' : 'none'
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4 drop-shadow-lg">
                    We're creating productivity partners, <span className="text-blue-400">not task managers</span>
                  </h3>
                </div>
              </div>
            </div>
